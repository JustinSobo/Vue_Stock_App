...
export declare const snapshotOptionContract: (apiKey: string, apiBase: string, underlyingAsset: string, optionContract: string) => Promise<IOptionsSnapshotContract>;
