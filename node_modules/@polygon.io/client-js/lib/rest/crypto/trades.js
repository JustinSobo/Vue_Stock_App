...
const trades = (apiKey, apiBase, cryptoTicker, query) => __awaiter(void 0, void 0, void 0, function* () { return (0, request_1.get)(`/v3/trades/${cryptoTicker}`, apiKey, apiBase, query); });
